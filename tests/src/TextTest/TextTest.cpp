...
void Main::updateStateFrame(double simulation_frame_time) {
    ...
    node2->setPosition(node2->getPosition() + (dt::Vector3(1, 1, 0) * simulation_frame_time));   //Move too fast before so I decrease the speed.
...
void Main::onInitialize() {
    ...
    camnode->setPosition(dt::Vector3(0, 0, 10));
    ...
    node2->setPosition(dt::Vector3(0, 0, 0));                       //Out of screen before...
    ...
    node3->setPosition(dt::Vector3(0, 0, 10));
